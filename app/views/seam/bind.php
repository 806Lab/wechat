...
<div class="container">
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/wechat/index.php/seam/bind">绑定</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <?php if ($result === false): ?>
        <form class="form-inline" action="/wechat/index.php/seam/add" method="post">
    ...
    <?php else: ?>
        <form class="form-inline" action="/wechat/index.php/seam/delete" method="get">
            <div class="form-group">
